package net.wasabo.tutorialmod.block;
...
import net.wasabo.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block ENDSTONE_RUBY_ORE = registerBlock("end_stone_ruby_ore",
